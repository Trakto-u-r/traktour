...
/**
 * Defines bit layout for tractors. (speed, access, ferries, ...)
 *
 * @author Peter Karich
 * @author Nop
 */
public class TractorsFlagEncoder extends AbstractFlagEncoder {
    ...
    public TractorsFlagEncoder() {
        this(5, 5, 0);
    }

    public TractorsFlagEncoder(PMap properties) {
    ...
    public TractorsFlagEncoder(String propertiesStr) {
        this(new PMap(propertiesStr));
    }

    public TractorsFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
        super(speedBits, speedFactor, maxTurnCosts);

        restrictions.addAll(Arrays.asList("vehicle", "access"));
        ...
        // bundesstraße (Trunk commonly used as Kraftfahrtstraße with some restriction regarding min speed)
        // defaultSpeedMap.put("trunk", 40);
        // defaultSpeedMap.put("trunk_link", 20);
        // linking bigger town
        defaultSpeedMap.put("primary", 40);
        defaultSpeedMap.put("primary_link", 20);
    ...
    /**
     * Define the place of the speedBits in the edge flags for tractors.
     */
    @Override
    ...
    public EncodingManager.Access getAccess(ReaderWay way) {
        ...
        if ((way.hasTag("motorroad", "yes")) ||
            ...
            // for motorroad check https://wiki.openstreetmap.org/wiki/Key:motorroad
            return EncodingManager.Access.CAN_SKIP;
        }
        ...
        // do not drive tractors into fords
