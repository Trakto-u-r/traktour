...
/**
 * Defines bit layout for tractors (T). (speed, access, ferries, ...)
 *
 * @author Peter Karich
 * @author Nop
 */
public class TractorFlagEncoder extends AbstractFlagEncoder {
    ...
    public TractorFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
        ...
        trackTypeSpeedMap.put("grade2", 15); // unpaved - gravel mixed with ...
    ...
    /**
     * Define the place of the speedBits in the edge flags for a tractor (T).
     */
    @Override
    ...
    public EncodingManager.Access getAccess(ReaderWay way) {
        ...
        // do not drive tractors (T) into fords
